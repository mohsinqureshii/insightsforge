...
const ACTION_COLORS: Record<string, string> = {
  ...
  dashboard_created: 'bg-purple-100 text-purple-700',
  dashboard_deleted: 'bg-red-100 text-red-700',
  export_downloaded: 'bg-yellow-100 text-yellow-700',
  api_key_created: 'bg-teal-100 text-teal-700',
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">{total.toLocaleString()} events</p>
          </div>
        </div>
                  ...
                  entries.map((entry) => (
                    <tr key={entry.id} className="border-b last:border-0 hover:bg-muted/30">
                      ...
                      <td className="px-4 py-3">
                        <div className="text-xs font-medium">{entry.userName ?? 'System'}</div>
